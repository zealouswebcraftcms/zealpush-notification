...
/**
 * ZealpushNotificationFieldFieldAsset AssetBundle
 *
 ...
 * @since     1.0.0
 */
class ZealpushNotificationFieldFieldAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->js = [
            'js/ZealpushNotificationField.js',
        ];

        $this->css = [
            'css/ZealpushNotificationField.css',
        ];
