...
/**
 * ZealpushNotificationField Field
 *
 ...
 * @since     1.0.0
 */
class ZealpushNotificationField extends Field
{
    // Public Properties
    // =========================================================================
    ...
    {
        return Craft::t('zealpush-notification', 'Zealpush Notification Field');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'zealpush-notification/_components/fields/ZealpushNotificationField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ZealpushNotificationFieldFieldAsset::class);
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').ZealpushNotificationZealpushNotificationField(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'zealpush-notification/_components/fields/ZealpushNotificationField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
    ...
    {
        return Craft::t('zealpush-notification', 'Add a Notification');
    }
    ...
    {
        return WebNotificationElements::class;
    }
}
